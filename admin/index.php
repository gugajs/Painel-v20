                                ...
                                <div class="card rounded-0 mb-0 px-2">
                                    <div class="card-header pb-1">
                                        <div class="card-title">
                                            <h4><i class="fa fa-linux"></i><b> JSINFINITY PREMIUM</b></h4>
                                        </div>
                                    </div>
                                    ...
                                    <div class="login-footer">                              
                                        <div class="footer-btn d-inline text-center">
                                            ...
                                            <div class="card-body">
                                            <p><b>JSINFINITY PREMIUM</b> &copy; <script> document.write(new Date().getFullYear())</script> Todos os direitos reservados.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
